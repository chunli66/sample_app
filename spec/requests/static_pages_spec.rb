...
describe "Help page" do
  ...
  it "should have the title 'Help'" do
    visit '/static_pages/help'
    page.should have_selector('title',:content => "Ruby on Rails Tutorial Sample App | Help")
  end
end
...
describe "About page" do
  ...
  it "should have the title 'About Us'" do
    visit '/static_pages/about'
    page.should have_selector('title',:content => "Ruby on Rails Tutorial Sample App | About Us")
  end
